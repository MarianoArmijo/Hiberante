 ...
 * checkked exceptions in a *framework* is in almost all cases evil. 
	...
	we learned from that mistake in Hibrenate 2 and changed it for Hibernate 3 ...the code 
	is *much* cleaner now when you are not *forced* to always catch or throw.
 * 
 * @author Vale
 *
 */
